...
" Extended settings
let nvim_settings_dir='~\vimfiles\settings\'
execute 'source '.nvim_settings_dir.'mypopup.vim'
execute 'source '.nvim_settings_dir.'mymaps.vim'
execute 'source '.nvim_settings_dir.'nerdtree.vim'
execute 'source '.nvim_settings_dir.'mycolor.vim'
execute 'source '.nvim_settings_dir.'mycoc.vim'
